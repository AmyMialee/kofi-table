...
public class KofiTable implements ModInitializer {
    ...
    public static final ItemGroup KOFI_GROUP = FabricItemGroupBuilder.create(id("kofitable_group")).icon(() -> KofiTableItems.getRecipeKindIcon(KofiTableItems.MOD_ITEMS)).build();
